                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_project_stepper">
                    ...
                    <div class="container">
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                            ...
                            <!--layout-partial:partials/modals/create-project/steps/_type.html-->
                            @include('partials.modals.create-project.steps._type')
                            <!--layout-partial:partials/modals/create-project/steps/_settings.html-->
                            @include('partials.modals.create-project.steps._settings')
                            <!--layout-partial:partials/modals/create-project/steps/_budget.html-->
                            @include('partials.modals.create-project.steps._budget')
                            <!--layout-partial:partials/modals/create-project/steps/_team.html-->
                            @include('partials.modals.create-project.steps._team')
                            <!--layout-partial:partials/modals/create-project/steps/_targets.html-->
                            @include('partials.modals.create-project.steps._targets')
                            <!--layout-partial:partials/modals/create-project/steps/_files.html-->
                            @include('partials.modals.create-project.steps._files')
                            <!--layout-partial:partials/modals/create-project/steps/_complete.html-->
