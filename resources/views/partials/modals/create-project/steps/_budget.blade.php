    ...
    <div class="w-100">
        ...
        <div class="fv-row mb-8">
            ...
            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                ...
                <!--layout-partial:partials/general/_bank-popover-hint.html-->
                @include('partials.general._form-tooltip-hint', ['hint' => 'Specify your project budget'])
            </label>
            <!--end::Label-->
            <!--begin::Dialer-->
            <div class="position-relative w-lg-250px" id="kt_modal_create_project_budget_setup" data-kt-dialer="true"
                ...
                <input type="text" class="form-control form-control-solid border-0 ps-12"
                    data-kt-dialer-control="input" placeholder="Amount" name="budget_setup" readonly value="$50" />
                <!--end::Input control-->
