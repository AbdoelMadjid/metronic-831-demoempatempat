...
if (!function_exists('getPageTitle')) {
    ...
    function getPageTitle(): string
    {
        ...
        $configs = [
            '_sidebar_dashboard' => ['menus_dashboard', 'menus_dashboard_collapsed'],
            '_sidebar_pages'     => ['pages_menus'],
            '_sidebar_apps'      => ['apps_menus'],
            '_sidebar_layouts'   => ['layout_menus'],
            '_sidebar_helps'     => ['help_menus'],
        ];
                ...
                if (!empty($menus)) {
                    foreach ($menus as $item) {
                        ...
                        if (isset($item['route']) && $item['route'] === $currentRoute) {
                            return $item['title'] ?? config('app.name', 'Metronic831-Laravel12');
                        }
        ...
        return config('app.name', 'Metronic831-Laravel12');
    }
}
